...
const createGroupChat = catchAsyncErrors(async (req, res, next) => {
...
const removeFromGroup = catchAsyncErrors(async (req, res, next) => {
...
// Add user to Group
const addToGroup = catchAsyncErrors(async (req, res, next) => {
    const { chatId, userId } = req.body;
